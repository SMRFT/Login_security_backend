...
print("Starting up server with prod configuration")
...
SECRET_KEY = 'django-insecure-z&lr(&27n%a#wu6fgn9t50z@m$t1b1ez5+m#8hm(xij4+o9yju'
...
MIDDLEWARE = [
    ...
    'authentication.middleware.SingleDeviceLoginMiddleware',  # Single Device Login enforcement
]
